    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.jsp">
                ...
                <div class="sidebar-brand-text mx-3">Clínica Odontológico</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="altaOdontologo.jsp">Crear Odontólogo</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="altaUsuarios.jsp">Crear Usuarios</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCitas" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Acciones:</h6>
                        <a class="collapse-item" href="SvCitas">Ver Citas</a>
                        <a class="collapse-item" href="SvDisponibilidad">Crear Citas</a>
                    </div>
                </div>
            </li>
             ...
             <li class="nav-item">
                ...
                <div id="collapseSecretary" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Acciones:</h6>
                        <a class="collapse-item" href="SvSecretaria">Ver Secretarias</a>
                        <a class="collapse-item" href="altaSecretaria.jsp">Crear Secretaria</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseResponsable" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="altaResponsable.jsp">Crear Responsable</a>
